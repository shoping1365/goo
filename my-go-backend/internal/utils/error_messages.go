...
// ErrorMessages maps error codes to Persian error messages.
// دسته‌بندی شده برای توسعه و نگهداری آسان. قابل گسترش برای چندزبانه در آینده.
var ErrorMessages = map[string]string{
	// ═══════════════════════════════════════════════════════════════
	// دسته ۱: خطاهای اعتبارسنجی ورودی (Input Validation)
	// ═══════════════════════════════════════════════════════════════
	"VALIDATION_ERROR":  "اطلاعات وارد شده معتبر نیست.",
	"REQUIRED_FIELD":    "فیلد مورد نیاز است.",
	"INVALID_FORMAT":    "فرمت ورودی صحیح نیست.",
	...
	"OUT_OF_RANGE":      "مقدار خارج از بازه مجاز است.",
	"TOO_SHORT":         "تعداد کاراکتر وارد شده کمتر از حد مجاز است.",
	"TOO_LONG":          "تعداد کاراکتر وارد شده بیشتر از حد مجاز است.",
	...
	"DUPLICATE_POST":      "نوشته با این عنوان یا اسلاگ قبلاً وجود دارد.",
	...
	"ATTRIBUTE_VALUE_REQUIRED": "انتخاب مقدار برای ویژگی الزامی است.",
	"VARIANT_NOT_AVAILABLE":    "این تنوع محصول موجود نیست.",
}

// GetErrorMessage returns the Persian error message for a given code.
// اگر کد یافت نشد، پیام پیش‌فرض برمی‌گرداند.
