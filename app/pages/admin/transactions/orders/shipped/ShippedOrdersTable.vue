    ...
    <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-4 py-3 border-b border-gray-200">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2 space-x-reverse">
          <button class="text-green-600 hover:text-green-800 text-sm font-medium" @click="exportOrders">
          ...
          <tr v-for="order in paginatedOrders" :key="order.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
              <div class="flex items-center space-x-2">
                ...
                <button class="text-green-600 hover:text-green-900" @click="trackOrder(order)">رهگیری</button>
              </div>
            </td>
          </tr>
        </tbody>
