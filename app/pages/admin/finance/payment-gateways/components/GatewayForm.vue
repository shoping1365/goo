<template>
  <div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden" style="box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);">
      ...
      <div class="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-8 relative overflow-hidden">
        ...
        <div class="relative flex items-center justify-between">
          ...
          <TemplateButton 
            ...
            hoverClass="hover:from-white/30 hover:to-white/20 hover:border-white/50"
            focusClass="focus:ring-2 focus:ring-white/50 focus:ring-offset-2"
            size="large"
            customClass="backdrop-blur-sm font-bold text-lg"
          >
            بازگشت
          </TemplateButton>
        </div>
      ...
      <form @submit.prevent="handleSubmit" class="p-8 bg-gradient-to-br from-gray-50 to-white">
        <!-- نمایش خطاهای اعتبارسنجی -->
        <div v-if="showErrors && validationErrors.length > 0" 
        ...
        <div class="flex bg-white rounded-2xl p-2 shadow-lg border border-gray-100 mb-8">
          <button v-for="(tab, index) in formTabs" :key="tab.value" @click="activeTab = tab.value" type="button"
            :class="[
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-3">
                  ...
                  <select v-model="form.type" required @change="onGatewayTypeChange" 
                ...
                <div class="space-y-3">
                  ...
                  <input v-model.number="form.fee" type="number" min="0" max="100" step="0.1" 
                    class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl text-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all bg-white hover:bg-gray-50 shadow-sm"
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 shadow-lg border border-blue-100">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-3">
                  ...
                  <input v-model="form.apiKeys.publicKey" type="text" 
            ...
            <div v-if="form.type" class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 shadow-lg border border-purple-100">
              ...
              <div v-if="form.type === 'zarinpal'" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-3">
                  ...
                  <input v-model="form.merchantId" type="text" required 
                ...
                <div class="space-y-3">
                  ...
                  <input v-model="form.apiEndpoints.callback" type="url" 
                    class="w-full px-5 py-4 border-2 border-purple-200 rounded-xl text-sm focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all bg-white hover:bg-purple-50 shadow-sm" 
              ...
              <div v-if="form.type === 'mellat'" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-3">
                  <label class="block text-sm font-bold text-gray-700">شماره ترمینال *</label>
                  <input v-model="form.terminalId" type="text" required 
                    class="w-full px-5 py-4 border-2 border-purple-200 rounded-xl text-sm focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all bg-white hover:bg-purple-50 shadow-sm" 
                ...
                <div class="space-y-3">
                  ...
                  <input v-model="form.apiKeys.publicKey" type="text" required 
                    class="w-full px-5 py-4 border-2 border-purple-200 rounded-xl text-sm focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all bg-white hover:bg-purple-50 shadow-sm" 
                    placeholder="نام کاربری دریافتی از بانک ملت">
                </div>
                <div class="space-y-3">
                  <label class="block text-sm font-bold text-gray-700">رمز عبور *</label>
                  <input v-model="form.apiKeys.privateKey" type="password" required 
                    class="w-full px-5 py-4 border-2 border-purple-200 rounded-xl text-sm focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all bg-white hover:bg-purple-50 shadow-sm" 
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 shadow-lg border border-yellow-100">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-3">
                  ...
                  <textarea v-model="form.security.ipWhitelist" rows="4" 
                ...
                <div class="space-y-6">
                  <div class="flex items-center space-x-4 space-x-reverse p-6 bg-white rounded-xl border-2 border-yellow-200">
                    <input v-model="form.security.httpsRequired" type="checkbox" id="httpsRequired" 
                  ...
                  <div class="space-y-3">
                    ...
                    <input v-model.number="form.security.maxAttempts" type="number" min="1" max="10" 
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 shadow-lg border border-green-100">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex items-center space-x-4 space-x-reverse p-6 bg-white rounded-xl border-2 border-green-200">
                  <input v-model="form.testMode" type="checkbox" id="testMode" 
                ...
                <div class="space-y-3">
                  ...
                  <input v-model="form.testCard" type="text" 
                ...
                <div class="space-y-3">
                  ...
                  <input v-model.number="form.testAmount" type="number" min="1000" 
                    class="w-full px-5 py-4 border-2 border-green-200 rounded-xl text-sm focus:ring-4 focus:ring-green-100 focus:border-green-500 transition-all bg-white hover:bg-green-50 shadow-sm">
                </div>
              </div>
            </div>
        ...
        <div class="flex items-center justify-between pt-8 border-t border-gray-200 mt-8">
          ...
          <TemplateButton 
            ...
            size="large"
            customClass="font-bold shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            انصراف
          </TemplateButton>
          ...
          <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <TemplateButton 
              ...
              borderColor="border border-blue-300"
              hoverClass="hover:from-blue-100 hover:to-blue-200"
            ...
            <TemplateButton 
              ...
              focusClass="focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
              size="large"
              customClass="font-bold flex items-center shadow-lg mr-4"
            >
            ...
            <TemplateButton 
              ...
              focusClass="focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              size="large"
              customClass="font-bold flex items-center shadow-lg hover:shadow-xl transform hover:scale-105"
