        ...
        <div class="bg-white rounded-xl shadow-sm border border-emerald-100 p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="space-y-3">
              ...
              <input type="text" class="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-900 transition-all duration-200" placeholder="مثال: رنگ، سایز، جنس" />
            </div>
            ...
            <div class="flex items-end">
              <button class="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg px-6 py-3 font-semibold hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full text-xs text-right rtl border-collapse">
            ...
            <tr class="border-b hover:bg-gray-50 border-blue-200">
              ...
              <td class="px-3 py-2 text-right">رنگ</td>
              <td class="px-3 py-2 text-right">قرمز، آبی، سبز</td>
              <td class="px-3 py-2 text-right">ندارد</td>
            ...
            <tr class="border-b hover:bg-gray-50 border-blue-200">
              ...
              <td class="px-3 py-2 text-right">لیست کشویی</td>
              <td class="px-3 py-2 text-right">S، M، L، XL</td>
              <td class="px-3 py-2 text-right">+5000 برای XL</td>
              <td class="px-3 py-2 text-center">
                <button class="text-blue-500 hover:text-blue-700">ویرایش</button>
              </td>
              <td class="px-3 py-2 text-center">
        ...
        <div class="border border-blue-200 rounded p-3 bg-gray-50">
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-2">
            <div class="flex flex-col gap-1">
              ...
              <select v-model="colorValue" class="input input-bordered w-full text-xs">
                <option>قرمز</option>
                <option>آبی</option>
                <option>سبز</option>
              </select>
            ...
            <div class="flex flex-col gap-1">
              ...
              <select v-model="sizeValue" class="input input-bordered w-full text-xs">
                <option>S</option>
                <option>M</option>
                <option>L</option>
                <option>XL</option>
            ...
            <div class="flex flex-col gap-1">
              ...
              <input v-model.number="variantPrice" type="number" class="input input-bordered w-full text-xs" min="0" placeholder="50000" />
            </div>
            <div class="flex flex-col gap-1">
