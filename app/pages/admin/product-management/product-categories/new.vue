                    ...
                    <!-- Flex container with reversed order -->
                      ...
                      <img :src="imagePreview" alt="Preview" class="w-12 h-12 object-contain rounded border ml-3" />
                          ...
                          <div class="flex gap-2">
                            <button type="button" @click="openMedia" class="bg-blue-500/20 text-blue-600 rounded-md px-4 py-2 text-sm hover:bg-blue-500/30 transition-colors font-semibold">انتخاب از رسانه</button>
                          </div>
    ...
    import { computed, defineAsyncComponent, onMounted, ref } from 'vue';
      ...
      import CategorySearchBox from '~/components/admin/CategorySearchBox.vue';
