    ...
    <div v-show="sections.seoBasic" class="p-8">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-emerald-100 p-6">
          ...
          <input type="text" class="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-gray-900 transition-all duration-200 text-sm" dir="rtl" placeholder="عنوان برای موتورهای جستجو" v-model="seoTitle" />
