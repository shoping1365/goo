<template>
  <div class="create-mobile-app-footer-page">
    <div class="header-bg">
      <div class="page-header-flex">
        <div>
          <h1 class="page-title">ایجاد فوتر موبایل و اپلیکیشن</h1>
          <p class="page-subtitle">فوتر جدید برای موبایل و اپلیکیشن ایجاد کنید</p>
        </div>
      ...
      <form @submit.prevent="createMobileAppFooter" class="mobile-app-footer-form">
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="btn btn-primary" :disabled="loading">
            ...
            <span v-else>ایجاد فوتر موبایل و اپلیکیشن</span>
          </button>
        </div>
      </form>
    </div>
...
const createMobileAppFooter = async () => {
  loading.value = true
