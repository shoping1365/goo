            ...
            <div>
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  placeholder="0"
                  @input="(e: any) => sliderConfig.padding_bottom = e.target.value === '' ? undefined : Number(e.target.value)"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  placeholder="0"
                  @input="(e: any) => sliderConfig.margin_right = e.target.value === '' ? undefined : Number(e.target.value)"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  placeholder="0"
                  @input="(e: any) => sliderConfig.margin_left = e.target.value === '' ? undefined : Number(e.target.value)"
                />
              </div>
            </div>
          </div>
...
const saveWidget = async () => {
  ...
  try {
    ...
    const configToSave = { ...sliderConfig.value }
    // اطمینان از ذخیره همه فیلدهای پدینگ و مارجین
    configToSave.padding_top = sliderConfig.value.padding_top
    configToSave.padding_bottom = sliderConfig.value.padding_bottom
    configToSave.margin_left = sliderConfig.value.margin_left
    configToSave.margin_right = sliderConfig.value.margin_right
    // اطمینان از ذخیره فیلدهای پدینگ و مارجین موبایل
    configToSave.mobile_padding_top = sliderConfig.value.mobile_padding_top
    configToSave.mobile_padding_bottom = sliderConfig.value.mobile_padding_bottom
    const widgetData = {
    ...
    if (updatedWidget) {
      // Redirect to widgets list page after successful update
...
onMounted(async () => {
  ...
  if (fetchedWidget.value?.config) {
    ...
    if (config.padding_top !== undefined && config.padding_top > 0) sliderConfig.value.padding_top = config.padding_top
    if (config.padding_bottom !== undefined && config.padding_bottom > 0) sliderConfig.value.padding_bottom = config.padding_bottom
    if (config.margin_left !== undefined && config.margin_left > 0) sliderConfig.value.margin_left = config.margin_left
    if (config.margin_right !== undefined && config.margin_right > 0) sliderConfig.value.margin_right = config.margin_right
    // Mobile specific settings
