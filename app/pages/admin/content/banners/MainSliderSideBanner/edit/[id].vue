  ...
  <div class="w-full">
    ...
    <div class="bg-white w-full shadow-sm border-2 border-blue-200 rounded-lg mt-4">
      <div class="flex justify-between items-center px-8 py-6">
        <h1 class="text-2xl font-bold text-gray-800">ویرایش اسلایدر اصلی و بنر کناری</h1>
        ...
        <div class="bg-white rounded-xl shadow p-8 mt-6 mx-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            <div>
              ...
              <input
                type="number"
                :value="sliderConfig.padding_top !== undefined ? sliderConfig.padding_top : ''"
                min="0"
                max="100"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                placeholder="0"
                @input="(e: Event) => sliderConfig.padding_top = (e.target as HTMLInputElement).value === '' ? undefined : Number((e.target as HTMLInputElement).value)"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="number"
                :value="sliderConfig.padding_bottom !== undefined ? sliderConfig.padding_bottom : ''"
                min="0"
                max="100"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                placeholder="0"
                @input="(e: Event) => sliderConfig.padding_bottom = (e.target as HTMLInputElement).value === '' ? undefined : Number((e.target as HTMLInputElement).value)"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="number"
                :value="sliderConfig.margin_right !== undefined ? sliderConfig.margin_right : ''"
                min="0"
                max="100"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                placeholder="0"
                @input="(e: Event) => sliderConfig.margin_right = (e.target as HTMLInputElement).value === '' ? undefined : Number((e.target as HTMLInputElement).value)"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="number"
                :value="sliderConfig.margin_left !== undefined ? sliderConfig.margin_left : ''"
                min="0"
                max="100"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                placeholder="0"
                @input="(e: Event) => sliderConfig.margin_left = (e.target as HTMLInputElement).value === '' ? undefined : Number((e.target as HTMLInputElement).value)"
              />
            </div>
...
useHead({ title: 'ویرایش اسلایدر همراه با بنر - پنل ادمین' })
...
const handleBannerSave = (bannerData: SlideItem, showTitle: boolean) => {
  ...
  // Force reactivity update (only for the active array)
  if (activeDeviceTab.value === 'mobile') {
    sliderConfig.value.mobile_side_banners = [...sliderConfig.value.mobile_side_banners]
  } else {
...
// Ensure current indices stay in range when filtered collections change
...
onMounted(async () => {
  ...
  if (widget.value?.config) {
    ...
    if (config.mobile_side_banners) sliderConfig.value.mobile_side_banners = config.mobile_side_banners
    ...
    // Mobile settings
    if (config.mobile_padding_top !== undefined) sliderConfig.value.mobile_padding_top = config.mobile_padding_top
    if (config.mobile_padding_bottom !== undefined) sliderConfig.value.mobile_padding_bottom = config.mobile_padding_bottom
    if (config.mobile_margin_left !== undefined) sliderConfig.value.mobile_margin_left = config.mobile_margin_left
    if (config.mobile_margin_right !== undefined) sliderConfig.value.mobile_margin_right = config.mobile_margin_right
    if (config.mobile_slider_width !== undefined) sliderConfig.value.mobile_slider_width = config.mobile_slider_width
    if (config.mobile_banner_width !== undefined) sliderConfig.value.mobile_banner_width = config.mobile_banner_width
    if (config.mobile_height !== undefined) sliderConfig.value.mobile_height = config.mobile_height
    if (config.mobile_banner_height !== undefined) sliderConfig.value.mobile_banner_height = config.mobile_banner_height
    if (config.mobile_banner_position) sliderConfig.value.mobile_banner_position = config.mobile_banner_position
    if (config.mobile_bg_enabled !== undefined) sliderConfig.value.mobile_bg_enabled = config.mobile_bg_enabled
    if (config.mobile_bg_color) sliderConfig.value.mobile_bg_color = config.mobile_bg_color
    if (config.mobile_wide_bg !== undefined) sliderConfig.value.mobile_wide_bg = config.mobile_wide_bg
    if (config.mobile_autoplay_enabled !== undefined) sliderConfig.value.mobile_autoplay_enabled = config.mobile_autoplay_enabled
    if (config.mobile_autoplay_delay !== undefined) sliderConfig.value.mobile_autoplay_delay = config.mobile_autoplay_delay
    ...
    if (config.mobile_show_title !== undefined) sliderConfig.value.mobile_show_title = config.mobile_show_title
    if (config.mobile_show_description !== undefined) sliderConfig.value.mobile_show_description = config.mobile_show_description
